...
from ..cover import XCover, XCoverDualR3, XZigbeeCover, XCover91, XCover67
...
DEVICES = {
    ...
    67:[XCover67, LED, RSSI, spec(XSensor, param="per"), spec(XSensor, param="statu"), spec(XSensor, param="op")],
